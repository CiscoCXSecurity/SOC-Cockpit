...
Thanks for your interest in contributing to SOC Cockpit! Here are a few general
...
For instructions on setting up the project locally, building it, and the coding
conventions we follow, see [DEVELOPMENT.md](/DEVELOPMENT.md).

## Reporting Issues

Before reporting a new issue, please ensure that the issue was not already
reported or fixed by searching through our
[issues list](https://github.com/kue_cisco/SOC-Cockpit/issues).
...
We welcome anyone that wants to contribute to SOC Cockpit to triage and reply to
...
- Review and update the existing content of our
  [Wiki](https://github.com/kue_cisco/SOC-Cockpit/wiki) with up-to-date
  instructions and code samples.
- Review existing pull requests, and testing patches against real existing
  applications that use SOC Cockpit.
- Write a test, or add a missing test case to an existing test.

Thanks again for your interest on contributing to SOC Cockpit!
